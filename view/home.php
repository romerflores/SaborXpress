...
<html lang="es">
  ...
  <body>
    ...
    <!-- endinject -->
    <!-- plugin js for this page -->
    <script src="<?php echo URL_RESOURCES;?>/AdminCelestial/template/vendors/progressbar.js/progressbar.min.js"></script>
    <script src="<?php echo URL_RESOURCES;?>/AdminCelestial/template/vendors/chart.js/Chart.min.js"></script>
    <!-- End plugin js for this page -->
    <!-- Custom js for this page-->
    <script src="<?php echo URL_RESOURCES;?>/AdminCelestial/template/js/dashboard.js"></script>
