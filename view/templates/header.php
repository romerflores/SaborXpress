    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        ...
        <br>
          ...
          <h2 class="h4" style="color: brown; font-family: 'Calibri', sans-serif;">Isabella Coffe</h2>
        </a>
        <a class="navbar-brand brand-logo-mini" href="index.html"><img src="images/logo-mini.svg" alt="logo" style="max-width: 50px; height: auto;" />
        </a>
